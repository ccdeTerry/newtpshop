...
<!-- 商品列表 -->
    ...
    <div class="list-div" id="listDiv">
        ...
        <?php if(is_array($listInfo["data"])): $i = 0; $__LIST__ = $listInfo["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td align="center"><?php echo ($vo["id"]); ?></td>
                <td align="center" class="first-cell"><span><?php echo ($vo["role_name"]); ?></span></td>
                <td align="center">
                <a href="<?php echo U('disfetch','role_id='.$vo['id']);?>" target="_blank" title="赋予权限"><img src="/Public/resources/Admin/Images/icon_view.gif" width="16" height="16" border="0" />赋予权限</a>
                <a href="<?php echo U('roleEdit','role_id='.$vo['id']);?>" title="编辑"><img src="/Public/resources/Admin/Images/icon_edit.gif" width="16" height="16" border="0" />编辑</a>
                <a href="<?php echo U('roleDels','role_id='.$vo['id']);?>" onclick="" title="删除"><img src="/Public/resources/Admin/Images/icon_trash.gif" width="16" height="16" border="0" />删除</a></td>
