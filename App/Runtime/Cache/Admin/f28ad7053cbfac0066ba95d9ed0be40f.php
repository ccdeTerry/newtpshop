    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <input type='text' name='btime' id="btime" maxlength="20" value="<?php echo (date('Y-m-d H:i:s',$seckillInfo['btime'])); ?>" size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">结束时间:</td>
                <td>
                    <input type='text' name='etime' id="etime" maxlength="20" value="<?php echo (date('Y-m-d H:i:s',$seckillInfo['etime'])); ?>" size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">秒杀价格:</td>
                <td>
                    <input type='text' name='seckill_price' maxlength="20" value="<?php echo ($seckillInfo['seckill_price']); ?>" size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">商品数量:</td>
                <td>
                    <input type='text' name='goods_num' maxlength="20" value="<?php echo ($seckillInfo['goods_num']); ?>" size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <input type="hidden" name="id" value="<?php echo ($seckillInfo["id"]); ?>">
        </table>
