...
<h1>
    ...
    <span class="action-span"><a href="<?php echo U('ruleAdd');?>">添加分类</a></span>
    ...
    <div class="list-div" id="listDiv">
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" class="0">
                ...
                <span><a href="javascript:void(0)"><?php echo (str_repeat('--',$vo["level"])); echo ($vo["rule_name"]); ?></a></span>
                </td>
                <td width="15%"><?php echo ($vo["module_name"]); ?></td>
                <td width="15%"><?php echo ($vo["controller_name"]); ?></td>
                <td width="15%"><?php echo ($vo["action_name"]); ?></td>
               <td width="15%"><img src="/Public/resources/Admin/Images/<?php if(($vo["is_show"]) == "1"): ?>yes.gif <?php else: ?> no.gif<?php endif; ?>" /></td>
                
                <td width="30%" align="center">
                <a href="<?php echo U('ruleEdit','id='.$vo['id']);?>">编辑</a> |
                <a href="<?php echo U('delRule','id='.$vo['id']);?>" title="移除" onclick="">移除</a>
                </td>
