...
<!-- 商品列表 -->
    ...
    <div class="list-div" id="listDiv">
        ...
        <?php if(is_array($listInfo["list"])): $i = 0; $__LIST__ = $listInfo["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <a href="<?php echo U('recover','goods_id='.$vo['id']);?>" title="编辑"><img src="/Public/resources/Admin/Images/icon_edit.gif" width="16" height="16" border="0" />还原</a>
                <a href="<?php echo U('remove','goods_id='.$vo['id']);?>" onclick="" title="回收站"><img src="/Public/resources/Admin/Images/icon_trash.gif" width="16" height="16" border="0" />彻底删除</a></td>
