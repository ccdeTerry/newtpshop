		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/<?php echo ($goodsImg["0"]["goods_img"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/<?php echo ($goodsImg["0"]["goods_img"]); ?>" alt="" width="350" height="350"  />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($goodsImg)): $i = 0; $__LIST__ = $goodsImg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($i) == "1"): ?>class="cur"<?php endif; ?>>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="market_price"><span>市场定价：</span><em>￥<?php echo ($goodsInfo["market_price"]); ?></em></li>
						<li class="market_price"><span>本店定价：</span><em>￥<?php echo ($goodsInfo["shop_price"]); ?></em></li>
						<li class="shop_price"><span>秒杀价：</span> <strong>￥<?php echo ($goodsInfo["seckill_price"]); ?></strong> </li>
					...
					<li><span id="timebox" style="width: 200px;color: red;font-size: 18px;"><?php echo (date('H:i:s',$goodsInfo['btime'])); ?>秒杀准时开始</span></li>
                    </ul>
							...
							<li>
								<dl>
									...
									<dd>
                                        ...
                                        <button value="立即秒杀" data-goods-id="<?php echo ($goodsInfo["seckillid"]); ?>" id="seckill_but">立即秒杀</button>
									</dd>
								</dl>
							</li>
...
//                console(msg);
        ...
        //秒杀
        $('#seckill_but').click(function () {
            var seckill_id = $(this).attr('data-goods-id');
//            console.log(seckill_id);
//            console.log(12345);
			$.ajax({
			    url:"<?php echo U('userSeckill');?>",
                dataType:'json',
