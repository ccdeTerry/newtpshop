...
<head>
	...
	<link rel="stylesheet" href="/Public/resources/Home/style/fillin.css" type="text/css">
	...
	<script type="text/javascript" src="/Public/resources/Home/js/cart2.js"></script>
...
-->
					...
					<tfoot>
						<tr>
							<td colspan="5">
								<ul>
									<li>
										<span><?php echo ($goodsPrice['count']); ?> 件商品，总商品金额：</span>
										<em>￥<?php echo ($goodsPrice['price']); ?></em>
									</li>
									<!--<li>-->
										<!--<span>返现：</span>-->
										<!--<em>-￥240.00</em>-->
		...
		<div class="fillin_ft">
			...
			<p>应付总额：<strong>￥<?php echo ($goodsPrice['price']); ?>元</strong></p>
