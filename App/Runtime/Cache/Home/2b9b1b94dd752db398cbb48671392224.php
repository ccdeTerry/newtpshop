...
<head>
	...
	<link rel="stylesheet" href="/Public/resources/Home/style/list.css" type="text/css">
	...
	<script type="text/javascript" src="/Public/resources/Home/js/list.js"></script>
</head>
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<?php if(empty($_SESSION['user_id'])): ?><li>您好，欢迎来到京西！[<a href="<?php echo U('user/login',['reUri'=>__INFO__]);?>">登录</a>] [<a href="<?php echo U('user/register');?>">免费注册</a>] </li>
                        <?php else: ?>
	...
	<div class="list w1210 bc mt10">
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/Public/resources/Home/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/resources/Home/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/Public/resources/Home/images/list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="list_top">
				...
				<div class="hotsale fl">
					...
					<ul>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/resources/Home/images/acer4739.jpg" alt="" /></a></dt>
			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($data['data'])): $i = 0; $__LIST__ = $data['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<dl>
